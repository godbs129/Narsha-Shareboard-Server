...
CREATE TABLE `clipboard` (
  ...
  `board` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `date` timestamp NOT NULL,
  PRIMARY KEY (`boardId`),
  KEY `deviceId` (`deviceId`),
  CONSTRAINT `clipboard_ibfk_1` FOREIGN KEY (`deviceId`) REFERENCES `device` (`deviceId`)
...
CREATE TABLE `device` (
  `deviceId` int NOT NULL,
  `deviceName` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `deviceToken` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  CONSTRAINT `device_ibfk_2` FOREIGN KEY (`typeId`) REFERENCES `devicetype` (`typeId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `devicetype` (
  `typeId` int NOT NULL,
  `typeName` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`typeId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-10-24 11:43:37
